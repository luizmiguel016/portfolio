const idiomas = {
    'pt': {
        ...
        'resumo': 'Sou estudante de Engenharia de Software com forte atuação em desenvolvimento, análise de requisitos e gestão de sistemas. Trabalho com <span class="destaque">Java</span> e <span class="destaque">Python</span> para construir soluções sólidas, alinhando as necessidades do negócio às melhores práticas de programação. Além disso, tenho interesse crescente na área de <span class="destaque">Visão Computacional</span> e análise de dados, utilizando <span class="destaque">Python</span> e <span class="destaque">Power BI</span> para transformar dados em insights estratégicos. Estou em constante evolução, buscando sempre aprofundar meus conhecimentos para entregar sistemas eficientes e de alto impacto.',
    ...
    'en': {
        ...
        'resumo': 'I am a Software Engineering student with a strong focus on development, requirements analysis, and systems management. I work with <span class="destaque">Java</span> and <span class="destaque">Python</span> to build solid solutions, aligning business needs with programming best practices. Furthermore, I have a growing interest in <span class="destaque">Computer Vision</span> and data analysis, using <span class="destaque">Python</span> and <span class="destaque">Power BI</span> to transform data into strategic insights. I am constantly evolving, always seeking to deepen my knowledge to deliver efficient, high-impact systems.',
